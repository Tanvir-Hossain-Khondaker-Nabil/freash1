                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" value="{{ old('name', @$user->name) }}" placeholder="Enter Your Name">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control" id="email" value="{{ old('email', @$user->email) }}" placeholder="Enter Your Email">
                                        @error('email')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
